function [] = PRR3_Manipulator_Display_Plot(P11,P12,P13,d,b,t,a,Pe,D,dn)
...
aa=P11(1)-3*cos(b(1))-0.3*sin(b(1)),P11(1)-3*cos(b(1))+0.3*sin(b(1)),P11(1)+0.3*cos(b(1))+0.3*sin(b(1)),P11(1)+0.3*cos(b(1))-0.3*sin(b(1));
aa2=P11(2)-3*sin(b(1))+0.3*cos(b(1)),P11(2)-3*sin(b(1))-0.3*cos(b(1)),P11(2)+0.3*sin(b(1))-0.3*cos(b(1)),P11(2)+0.3*sin(b(1))+0.3*cos(b(1));
...
patch([P12(1)-3*cos(b(2))-0.3*sin(b(2)),P12(1)-3*cos(b(2))+0.3*sin(b(2)),P12(1)+0.3*cos(b(2))+0.3*sin(b(2)),P12(1)+0.3*cos(b(2))-0.3*sin(b(2))],...
      ...
      'k','FaceAlpha',0,'LineWidth',1);
bb2=P12(2)-3*sin(b(2))+0.3*cos(b(2)),P12(2)-3*sin(b(2))-0.3*cos(b(2)),P12(2)+0.3*sin(b(2))-0.3*cos(b(2)),P12(2)+0.3*sin(b(2))+0.3*cos(b(2));
...
patch([P13(1)-3*cos(b(3))-0.3*sin(b(3)),P13(1)-3*cos(b(3))+0.3*sin(b(3)),P13(1)+0.3*cos(b(3))+0.3*sin(b(3)),P13(1)+0.3*cos(b(3))-0.3*sin(b(3))],...
      ...
      'k','FaceAlpha',0,'LineWidth',1);
cc2=P13(2)-3*sin(b(3))+0.3*cos(b(3)),P13(2)-3*sin(b(3))-0.3*cos(b(3)),P13(2)+0.3*sin(b(3))-0.3*cos(b(3)),P13(2)+0.3*sin(b(3))+0.3*cos(b(3));
hold on
...
drawnow;
if(dn==1)
    text((P11(1)+P11(1)+d(1)*cos(b(1)))/2,(P11(2)+P11(2)+d(1)*sin(b(1)))/2+1, num2str((b(1)*180/pi)), 'FontWeight','Bold');
    text((P11(1)+P11(1)+d(1)*cos(b(1)))/2,(P11(2)+P11(2)+d(1)*sin(b(1)))/2+1.5, num2str(180+(aa2*180/pi)), 'FontWeight','Bold');
    text((P11(1)+P11(1)+d(1)*cos(b(1)))/2,(P11(2)+P11(2)+d(1)*sin(b(1)))/2,'d1','FontWeight','Bold');

    text((P12(1)+P12(1)+d(2)*cos(b(2)))/2, (P12(2)+P12(2)+d(2)*sin(b(2)))/2+1, num2str((b(2)*180/pi)), 'FontWeight','Bold');
    text((P12(1)+P12(1)+d(2)*cos(b(2)))/2, (P12(2)+P12(2)+d(2)*sin(b(2)))/2+1.5, num2str(180+(bb2*180/pi)), 'FontWeight','Bold');
    text((P12(1)+P12(1)+d(2)*cos(b(2)))/2, (P12(2)+P12(2)+d(2)*sin(b(2)))/2  ,'d2','FontWeight','Bold');

    text((P13(1)+P13(1)+d(3)*cos(b(3)))/2, (P13(2)+P13(2)+d(3)*sin(b(3)))/2+1, num2str((b(3)*180/pi)), 'FontWeight','Bold');
    text((P13(1)+P13(1)+d(3)*cos(b(3)))/2, (P13(2)+P13(2)+d(3)*sin(b(3)))/2+1.5, num2str((180+cc2)), 'FontWeight','Bold');
