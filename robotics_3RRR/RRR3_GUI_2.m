function varargout = RRR3_GUI_2(varargin)
%RRR3_GUI_2 MATLAB code file for RRR3_GUI_2.fig
%      RRR3_GUI_2, by itself, creates a new RRR3_GUI_2 or raises the existing
%      singleton*.
%
%      H = RRR3_GUI_2 returns the handle to a new RRR3_GUI_2 or the handle to
%      the existing singleton*.
%
%      RRR3_GUI_2('Property','Value',...) creates a new RRR3_GUI_2 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to RRR3_GUI_2_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      RRR3_GUI_2('CALLBACK') and RRR3_GUI_2('CALLBACK',hObject,...) call the
%      local function named CALLBACK in RRR3_GUI_2.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help RRR3_GUI_2

% Last Modified by GUIDE v2.5 12-May-2024 22:40:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @RRR3_GUI_2_OpeningFcn, ...
                   'gui_OutputFcn',  @RRR3_GUI_2_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before RRR3_GUI_2 is made visible.
function RRR3_GUI_2_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for RRR3_GUI_2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes RRR3_GUI_2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = RRR3_GUI_2_OutputFcn(hObject, eventdata, handles)
...
% hObject    handle to display_names_checkbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of display_names_checkbox


% --- Executes on button press in display_scale_checkbox.
function display_scale_checkbox_Callback(hObject, eventdata, handles)
% hObject    handle to display_scale_checkbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of display_scale_checkbox
...
% hObject    handle to ymax_limit_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ymax_limit_edit as text
%        str2double(get(hObject,'String')) returns contents of ymax_limit_edit as a double
...
% hObject    handle to ymin_limit_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ymin_limit_edit as text
%        str2double(get(hObject,'String')) returns contents of ymin_limit_edit as a double
...
% hObject    handle to xmin_limit_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xmin_limit_edit as text
%        str2double(get(hObject,'String')) returns contents of xmin_limit_edit as a double
...
% hObject    handle to xmax_limit_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xmax_limit_edit as text
%        str2double(get(hObject,'String')) returns contents of xmax_limit_edit as a double
...
% hObject    handle to circle_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of circle_radio


% --- Executes on button press in ellipse_radio.
function ellipse_radio_Callback(hObject, eventdata, handles)
% hObject    handle to ellipse_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of ellipse_radio
...
% hObject    handle to simulation_time_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to trace_simulation_time_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of trace_simulation_time_edit as text
%        str2double(get(hObject,'String')) returns contents of trace_simulation_time_edit as a double
...
% hObject    handle to phie_desired_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to phie_desired_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of phie_desired_edit as text
%        str2double(get(hObject,'String')) returns contents of phie_desired_edit as a double
...
% hObject    handle to phiedot_desired_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to phiedot_desired_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of phiedot_desired_edit as text
%        str2double(get(hObject,'String')) returns contents of phiedot_desired_edit as a double
...
% hObject    handle to yoshi_manipulability_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to cond_manipulability_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to c_orient_workspace_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to dex_workspace_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to max_workspace_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to maximal_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of maximal_radio


% --- Executes on button press in dextrous_radio.
function dextrous_radio_Callback(hObject, eventdata, handles)
% hObject    handle to dextrous_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of dextrous_radio


% --- Executes on button press in const_orientation_radio.
function const_orientation_radio_Callback(hObject, eventdata, handles)
% hObject    handle to const_orientation_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of const_orientation_radio


% --- Executes on slider movement.
function a11_slider_Callback(hObject, eventdata, handles)
% hObject    handle to a11_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to a12_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to a13_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to a21_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to a22_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to a23_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to b3_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to phie_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to open_loop_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of open_loop_radio


% --- Executes on button press in joint_space_radio.
function joint_space_radio_Callback(hObject, eventdata, handles)
% hObject    handle to joint_space_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of joint_space_radio


% --- Executes on button press in task_space_radio.
function task_space_radio_Callback(hObject, eventdata, handles)
% hObject    handle to task_space_radio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of task_space_radio
